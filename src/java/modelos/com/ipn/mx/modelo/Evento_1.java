...
public class Evento_1 implements Serializable {
    ...
    public Evento_1(Integer idEvento) {
        this.idEvento = idEvento;
    }

    public Evento_1(Integer idEvento, String nombreEvento, Date fechaEvento, int duracionEvento, String fotoEvento) {
        this.idEvento = idEvento;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Evento_1)) {
            return false;
        }
        Evento_1 other = (Evento_1) object;
